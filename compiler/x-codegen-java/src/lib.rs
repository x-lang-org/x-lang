...
impl JavaBackend {
    ...
    /// Emit file header with package and imports (Java 21 LTS)
    fn emit_header(&mut self) -> JavaResult<()> {
        self.line("// Generated by X-Lang Java 21 backend")?;
        self.line("// DO NOT EDIT")?;
        self.line("// Target: Java 21 LTS")?;
        self.line("")?;
        // Java 21 标准库导入
